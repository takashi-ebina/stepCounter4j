...
public class CsCommentPatternMatch extends AbsCommentPatternMatch {
	...
	public boolean isSingleCommentPattern(final String target) {
		final Pattern singleCommentPattern = Pattern.compile(SingleCommentPattern.Cs.getValue());
	...
	public boolean isStartMultiCommentPattern(final String target) {
		final Pattern startMultiCommentPattern = Pattern.compile(StartMultiCommentPattern.Cs.getValue());
	...
	public boolean isEndMultiCommentPattern(final String target) {
		final Pattern endMultiCCommentPattern = Pattern.compile(EndMultiCommentPattern.Cs.getValue());
